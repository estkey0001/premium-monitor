...
- OPEN 72 / CLOSED 81（成功 25）
- Execution Success Rate: **30.9%**
- Prediction Accuracy: 予測 38.642% vs 実績 30.9%（誤差 7.7pt）
- Notification Accuracy: 通知61 / BUY通知1 / WATCH→BUY 1 / 偽陽性率 20%
- Capital Allocation: 期待 ¥499,800 → 実 ¥0（精度 0.0）

## 補正係数（学習・利益ロジックには不適用）

- Opportunity Score 係数: 1.034
- Success Probability 係数: 0.8
- Risk Score 係数: 1.0
- サンプル数 81（信頼度 high）
...
|---|---|---|---|---|---|
| camera | 65 | 38% | ¥4,885 | 3.3% | 1.1538日 |
| game_console | 16 | 0% | ¥-1,500 | -3.0% | 5.0日 |
