...
- OPEN 79 / CLOSED 98（成功 31）
- Execution Success Rate: **31.6%**
- Prediction Accuracy: 予測 38.8571% vs 実績 31.6%（誤差 7.3pt）
...
|---|---|---|---|---|---|
| camera | 77 | 40% | ¥5,113 | 3.4% | 1.2078日 |
| game_console | 21 | 0% | ¥-1,500 | -3.0% | 5.0日 |

## Insights — 今週学んだこと TOP10

1. カテゴリ「camera」の成功率が最も高い（40%）
2. RICOH GR IIIx は約3日で売却成立（回転が速い）
3. 成立確率の予測誤差は 7.3pt（概ね良好）
