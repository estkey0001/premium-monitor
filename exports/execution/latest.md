...
- OPEN 80 / CLOSED 113（成功 32）
- Execution Success Rate: **28.3%**
- Prediction Accuracy: 予測 37.9292% vs 実績 28.3%（誤差 9.6pt）
- Notification Accuracy: 通知73 / BUY通知1 / WATCH→BUY 1 / 偽陽性率 20%
- Capital Allocation: 期待 ¥0（実績データ蓄積待ち）

## 補正係数（学習・利益ロジックには不適用）

- Opportunity Score 係数: 1.071
- Success Probability 係数: 0.746
- Risk Score 係数: 1.0
- サンプル数 113（信頼度 high）
...
|---|---|---|---|---|---|
| camera | 91 | 35% | ¥4,466 | 3.0% | 1.0549日 |
