...
class Repository:
        ...
        self.db.connection.execute(
            """INSERT OR REPLACE INTO beginner_deals
               (id, product_id, product_name, category, brand,
                ...
                best_buyback_price, best_buyback_shop, best_buyback_url, best_link_verified,
                buyback_condition,
                median_buyback_price, buyback_shop_count, buyback_prices_json,
            ...
            (deal.id, deal.product_id, deal.product_name, deal.category, deal.brand,
             ...
             int(getattr(deal, "best_link_verified", False)),
             deal.buyback_condition,
             getattr(deal, "median_buyback_price", None),
             getattr(deal, "buyback_shop_count", 1),
             getattr(deal, "buyback_prices_json", ""),
    ...
    def list_beginner_deals(self, user_level: Optional[str] = None,
        ...
        for r in rows:
            ...
            result.append(BeginnerDealModel(
                ...
                best_link_verified=bool(d.get("best_link_verified", 0)),
                buyback_condition=d.get("buyback_condition", ""),
                median_buyback_price=d.get("median_buyback_price"),
                buyback_shop_count=d.get("buyback_shop_count", 1),
                buyback_prices_json=d.get("buyback_prices_json", ""),
    ...
    def list_price_history_by_product(
        self,
        product_id: str,
