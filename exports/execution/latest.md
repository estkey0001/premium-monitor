...
- OPEN 41 / CLOSED 56（成功 22）
- Execution Success Rate: **39.3%**
- Prediction Accuracy: 予測 41.0% vs 実績 39.3%（誤差 1.7pt）
- Notification Accuracy: 通知43 / BUY通知1 / WATCH→BUY 1 / 偽陽性率 23%
- Capital Allocation: 期待 ¥65,505 → 実 ¥0（精度 0.0）

## 補正係数（学習・利益ロジックには不適用）

- Opportunity Score 係数: 0.976
- Success Probability 係数: 0.959
- Risk Score 係数: 1.0
- サンプル数 56（信頼度 high）
