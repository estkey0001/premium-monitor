...
|---|---|---|---|---|---|
| FUJIFILM X100VI | ¥319,800 | ¥574,877 | +¥125,508 | 39% | overseas_sold_stale(43.3d) |
| iPhone 17 Pro 25 | ¥200,739 | ¥324,812 | +¥48,089 | 24% | overseas_sold_stale(43.3d) |
...
- eBay sold を fresh化すると成立する候補:
  - src_ebay ¥324,812 → 潜在 +¥48,089（ROI 24%）
...
- eBay sold を fresh化すると成立する候補:
  - src_ebay ¥574,877 → 潜在 +¥125,508（ROI 39%）
