...
- OPEN 27 / CLOSED 45（成功 20）
- Execution Success Rate: **44.4%**
- Prediction Accuracy: 予測 42.4444% vs 実績 44.4%（誤差 2.0pt）
- Notification Accuracy: 通知35 / BUY通知1 / WATCH→BUY 1 / 偽陽性率 24%
- Capital Allocation: 期待 ¥404,800 → 実 ¥0（精度 0.0）

## 補正係数（学習・利益ロジックには不適用）

- Opportunity Score 係数: 0.953
- Success Probability 係数: 1.046
- Risk Score 係数: 1.0
- サンプル数 45（信頼度 high）
...
|---|---|---|---|---|---|
| camera | 34 | 59% | ¥7,471 | 5.0% | 1.7647日 |
| game_console | 11 | 0% | ¥-1,500 | -3.0% | 5.0日 |

## Insights — 今週学んだこと TOP10

1. カテゴリ「camera」の成功率が最も高い（59%）
2. RICOH GR IIIx は約3日で売却成立（回転が速い）
3. 成立確率の予測誤差は 2.0pt（概ね良好）
