...
- OPEN 33 / CLOSED 52（成功 22）
- Execution Success Rate: **42.3%**
- Prediction Accuracy: 予測 41.8462% vs 実績 42.3%（誤差 0.5pt）
- Notification Accuracy: 通知40 / BUY通知1 / WATCH→BUY 1 / 偽陽性率 25%
- Capital Allocation: 期待 ¥291,103 → 実 ¥279,400（精度 0.96）

## 補正係数（学習・利益ロジックには不適用）

- Opportunity Score 係数: 0.951
- Success Probability 係数: 1.011
- Risk Score 係数: 1.0
- サンプル数 52（信頼度 high）
