...
- OPEN 80 / CLOSED 109（成功 32）
- Execution Success Rate: **29.4%**
- Prediction Accuracy: 予測 38.2202% vs 実績 29.4%（誤差 8.8pt）
- Notification Accuracy: 通知73 / BUY通知1 / WATCH→BUY 1 / 偽陽性率 20%
- Capital Allocation: 期待 ¥0（実績データ蓄積待ち）

## 補正係数（学習・利益ロジックには不適用）

- Opportunity Score 係数: 1.059
- Success Probability 係数: 0.769
- Risk Score 係数: 1.0
- サンプル数 109（信頼度 high）
...
|---|---|---|---|---|---|
| camera | 87 | 37% | ¥4,671 | 3.1% | 1.1034日 |
