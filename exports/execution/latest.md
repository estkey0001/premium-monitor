...
- OPEN 80 / CLOSED 101（成功 31）
- Execution Success Rate: **30.7%**
- Prediction Accuracy: 予測 38.5941% vs 実績 30.7%（誤差 7.9pt）
- Notification Accuracy: 通知69 / BUY通知1 / WATCH→BUY 1 / 偽陽性率 22%
- Capital Allocation: 期待 ¥0（実績データ蓄積待ち）

## 補正係数（学習・利益ロジックには不適用）

- Opportunity Score 係数: 1.045
- Success Probability 係数: 0.795
- Risk Score 係数: 1.0
- サンプル数 101（信頼度 high）
...
|---|---|---|---|---|---|
| camera | 79 | 39% | ¥4,984 | 3.3% | 1.1772日 |
