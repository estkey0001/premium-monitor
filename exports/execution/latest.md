...
- OPEN 53 / CLOSED 63（成功 22）
- Execution Success Rate: **34.9%**
- Prediction Accuracy: 予測 39.7778% vs 実績 34.9%（誤差 4.9pt）
- Notification Accuracy: 通知47 / BUY通知1 / WATCH→BUY 1 / 偽陽性率 21%
- Capital Allocation: 期待 ¥69,505 → 実 ¥0（精度 0.0）

## 補正係数（学習・利益ロジックには不適用）

- Opportunity Score 係数: 1.014
- Success Probability 係数: 0.877
- Risk Score 係数: 1.0
- サンプル数 63（信頼度 high）
