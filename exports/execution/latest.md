...
- OPEN 45 / CLOSED 59（成功 22）
- Execution Success Rate: **37.3%**
- Prediction Accuracy: 予測 40.4407% vs 実績 37.3%（誤差 3.1pt）
- Notification Accuracy: 通知47 / BUY通知1 / WATCH→BUY 1 / 偽陽性率 22%
- Capital Allocation: 期待 ¥67,005 → 実 ¥0（精度 0.0）

## 補正係数（学習・利益ロジックには不適用）

- Opportunity Score 係数: 0.993
- Success Probability 係数: 0.922
- Risk Score 係数: 1.0
- サンプル数 59（信頼度 high）
