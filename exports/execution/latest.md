...
- OPEN 59 / CLOSED 66（成功 22）
- Execution Success Rate: **33.3%**
- Prediction Accuracy: 予測 39.3333% vs 実績 33.3%（誤差 6.0pt）
- Notification Accuracy: 通知48 / BUY通知1 / WATCH→BUY 1 / 偽陽性率 20%
- Capital Allocation: 期待 ¥132,309 → 実 ¥0（精度 0.0）

## 補正係数（学習・利益ロジックには不適用）

- Opportunity Score 係数: 1.029
...
|---|---|---|---|---|---|
| camera | 53 | 42% | ¥5,272 | 3.5% | 1.2453日 |
