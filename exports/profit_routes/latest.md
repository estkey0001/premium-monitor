...
|---|---|---|---|---|---|
| FUJIFILM X100VI | ¥359,091 | ¥556,431 | +¥70,281 | 20% | overseas_sold_stale(29.3d) |
...
- 除外理由TOP5: [('price_zero', 5), ('stale_over_14d', 3), ('accessory_or_wrong_product', 2), ('duplicate_price_collision', 1)]
...
- buy候補 1 / sell候補 1 / stale除外 0 / 海外sold stale 0
...
- eBay sold を fresh化すると成立する候補:
  - src_ebay ¥556,431 → 潜在 +¥70,281（ROI 20%）
