...
- OPEN 80 / CLOSED 121（成功 32）
- Execution Success Rate: **26.4%**
- Prediction Accuracy: 予測 37.405% vs 実績 26.4%（誤差 11.0pt）
- Notification Accuracy: 通知75 / BUY通知1 / WATCH→BUY 1 / 偽陽性率 18%
- Capital Allocation: 期待 ¥0（実績データ蓄積待ち）

## 補正係数（学習・利益ロジックには不適用）

- Opportunity Score 係数: 1.093
- Success Probability 係数: 0.706
- Risk Score 係数: 1.0
- サンプル数 121（信頼度 high）
...
|---|---|---|---|---|---|
| camera | 99 | 32% | ¥4,105 | 2.8% | 0.9697日 |
...
3. 成立確率の予測誤差が 11.0pt（予測がやや強気→補正係数で校正）
