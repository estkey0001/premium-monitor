...
- OPEN 31 / CLOSED 49（成功 20）
- Execution Success Rate: **40.8%**
- Prediction Accuracy: 予測 41.4286% vs 実績 40.8%（誤差 0.6pt）
- Notification Accuracy: 通知35 / BUY通知1 / WATCH→BUY 1 / 偽陽性率 26%
- Capital Allocation: 期待 ¥406,300 → 実 ¥0（精度 0.0）

## 補正係数（学習・利益ロジックには不適用）

- Opportunity Score 係数: 0.954
- Success Probability 係数: 0.985
- Risk Score 係数: 1.0
- サンプル数 49（信頼度 high）
...
|---|---|---|---|---|---|
| camera | 36 | 56% | ¥7,056 | 4.7% | 1.6667日 |
