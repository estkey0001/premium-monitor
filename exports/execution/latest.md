...
- OPEN 43 / CLOSED 58（成功 22）
- Execution Success Rate: **37.9%**
- Prediction Accuracy: 予測 40.6207% vs 実績 37.9%（誤差 2.7pt）
- Notification Accuracy: 通知46 / BUY通知1 / WATCH→BUY 1 / 偽陽性率 22%
- Capital Allocation: 期待 ¥0（実績データ蓄積待ち）

## 補正係数（学習・利益ロジックには不適用）

- Opportunity Score 係数: 0.988
- Success Probability 係数: 0.933
- Risk Score 係数: 1.0
- サンプル数 58（信頼度 high）
