...
- OPEN 66 / CLOSED 70（成功 22）
- Execution Success Rate: **31.4%**
- Prediction Accuracy: 予測 38.8% vs 実績 31.4%（誤差 7.4pt）
- Notification Accuracy: 通知51 / BUY通知1 / WATCH→BUY 1 / 偽陽性率 19%
- Capital Allocation: 期待 ¥0（実績データ蓄積待ち）

## 補正係数（学習・利益ロジックには不適用）

- Opportunity Score 係数: 1.047
- Success Probability 係数: 0.809
- Risk Score 係数: 1.0
- サンプル数 70（信頼度 high）
...
|---|---|---|---|---|---|
| camera | 57 | 39% | ¥4,902 | 3.3% | 1.1579日 |
