...
> 生成: 2026-09-12 17:37 JST / 初回体験最適化・運用準備・βテスト計測・フィードバック（AI/利益/DataQualityロジックは不変）
...
- 登録者数: 3 / 通知数: 73 / Opportunity数: 1
- Execution成功率: 29.4 / Feedback件数: 0
