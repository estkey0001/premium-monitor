...
|---|---|---|---|---|---|
| FUJIFILM X100VI | ¥361,819 | ¥551,856 | +¥63,811 | 18% | overseas_sold_stale(27.3d) |

## 0件商品の診断

### iPhone 17 Pro 256GB SIMフリー
- buy候補 0 / sell候補 1 / stale除外 5 / 海外sold stale 1
...
### Nintendo Switch 2
- buy候補 1 / sell候補 1 / stale除外 4 / 海外sold stale 1
- 除外理由TOP5: [('price_zero', 9), ('stale_over_14d', 4)]
...
- eBay sold を fresh化すると成立する候補:
  - src_ebay ¥551,856 → 潜在 +¥63,811（ROI 18%）
