...
- OPEN 22 / CLOSED 37（成功 16）
- Execution Success Rate: **43.2%**
- Prediction Accuracy: 予測 42.1081% vs 実績 43.2%（誤差 1.1pt）
...
|---|---|---|---|---|---|
| camera | 28 | 57% | ¥7,257 | 4.9% | 1.7143日 |
| game_console | 9 | 0% | ¥-1,500 | -3.0% | 5.0日 |

## Insights — 今週学んだこと TOP10

1. カテゴリ「camera」の成功率が最も高い（57%）
2. RICOH GR IIIx は約3日で売却成立（回転が速い）
3. 成立確率の予測誤差は 1.1pt（概ね良好）
