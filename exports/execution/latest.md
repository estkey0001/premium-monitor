...
- OPEN 80 / CLOSED 117（成功 32）
- Execution Success Rate: **27.4%**
- Prediction Accuracy: 予測 37.6581% vs 実績 27.4%（誤差 10.3pt）
- Notification Accuracy: 通知73 / BUY通知1 / WATCH→BUY 1 / 偽陽性率 19%
- Capital Allocation: 期待 ¥0（実績データ蓄積待ち）

## 補正係数（学習・利益ロジックには不適用）

- Opportunity Score 係数: 1.082
- Success Probability 係数: 0.728
- Risk Score 係数: 1.0
- サンプル数 117（信頼度 high）
...
|---|---|---|---|---|---|
| camera | 95 | 34% | ¥4,278 | 2.9% | 1.0105日 |
...
3. 成立確率の予測誤差が 10.3pt（予測がやや強気→補正係数で校正）
