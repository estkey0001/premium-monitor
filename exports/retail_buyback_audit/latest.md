...
> 生成: 2026-09-01 18:17 JST / 販売/買取/二次流通の取得品質・正規化・同一性（利益/AI/UI/SaaSロジックは不変）
...
- price_type分布: {'buyback_price': 120, 'shop_sale_price': 26, 'overseas_listing_price': 5, 'flea_listing_price': 5, 'flea_sold_price': 17}
