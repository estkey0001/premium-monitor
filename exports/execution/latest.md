...
- OPEN 80 / CLOSED 104（成功 31）
- Execution Success Rate: **29.8%**
- Prediction Accuracy: 予測 38.3462% vs 実績 29.8%（誤差 8.5pt）
- Notification Accuracy: 通知71 / BUY通知1 / WATCH→BUY 1 / 偽陽性率 21%
- Capital Allocation: 期待 ¥0（実績データ蓄積待ち）

## 補正係数（学習・利益ロジックには不適用）

- Opportunity Score 係数: 1.055
- Success Probability 係数: 0.777
- Risk Score 係数: 1.0
- サンプル数 104（信頼度 high）
...
|---|---|---|---|---|---|
| camera | 82 | 38% | ¥4,801 | 3.2% | 1.1341日 |
